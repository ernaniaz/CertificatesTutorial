...
#=============================================================================
# Lab 07: Cleanup
# Remove NGINX and restore system state
#
# Usage: ./cleanup.sh
...
# Confirmation
print_warning "This will remove NGINX and all configurations."
...
# Remove lab configuration (in case nginx was not fully removed)
if [[ -f /etc/nginx/conf.d/lab-ssl.conf ]]; then
  rm -f /etc/nginx/conf.d/lab-ssl.conf
  print_success "Lab configuration removed"
fi
