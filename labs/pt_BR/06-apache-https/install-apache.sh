...
print_header "Lab 06: Instalando Apache com SSL"
...
# Instalar Apache
print_info "Instalando httpd e mod_ssl..."
...
print_info "Habilitando e iniciando serviço httpd..."
systemctl enable httpd
systemctl start httpd

print_success "Serviço Apache iniciado"
echo
...
if systemctl is-active httpd &>/dev/null; then
  ...
  print_error "Apache falhou ao iniciar"
  exit 1
fi

# Verificar se está escutando
if ss -tlnp | grep -q ':80\|:443'; then
  print_success "Apache escutando em portas"
fi

echo
print_success "Instalação Apache concluída"
echo
echo "Status Apache:"
