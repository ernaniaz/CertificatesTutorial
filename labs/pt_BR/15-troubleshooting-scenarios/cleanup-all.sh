#!/usr/bin/env bash
#=============================================================================
# Lab 15: Limpeza completa
# Remove todos os artefatos dos cenários
#
# Uso: ./cleanup-all.sh
...
print_header "Lab 15: Limpar Todos os Cenários"
...
print_info "Removendo certificados e arquivos do cenário..."
...
# Cenário 02: Certificado incorreto
