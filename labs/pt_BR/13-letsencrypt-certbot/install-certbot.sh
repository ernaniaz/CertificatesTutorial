...
# Instala o certbot para Let's Encrypt
#
...
print_header "Lab 13: Instalando Certbot"
...
# Instalar Certbot
print_info "Habilitando repositório EPEL..."
...
# Exibir versão do certbot
certbot --version

echo
print_success "Instalação do Certbot concluída"
echo
print_warning "Nota: Let's Encrypt requer:"
echo "  - Conectividade com a internet"
echo "  - Porta 80 acessível (para desafio HTTP-01)"
echo "  - Nome de domínio válido apontando para este servidor"
echo
print_warning "Para teste sem domínio real, use:"
echo "  - Modo standalone (servidor embutido temporário)"
echo "  - Ambiente de staging: certbot --staging"
echo
