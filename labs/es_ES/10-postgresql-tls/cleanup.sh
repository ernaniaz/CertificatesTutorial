...
#=============================================================================
# Lab 10: Limpieza
# Elimina PostgreSQL y restaura el estado del sistema
#
# Uso: ./cleanup.sh
...
# Confirmación
print_warning "Esto eliminará PostgreSQL y todas las configuraciones del lab."
print_warning "Los datos de la base de datos se conservarán pero el servicio será eliminado."
...
print_info "Eliminando paquetes PostgreSQL..."
...
print_success "PostgreSQL eliminado"
echo
...
echo "Nota: Datos de la base de datos en ${PG_DATA} conservados"
