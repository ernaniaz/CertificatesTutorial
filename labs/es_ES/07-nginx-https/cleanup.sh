...
#=============================================================================
# Lab 07: Limpieza
# Elimina NGINX y restaura el estado del sistema
#
# Uso: ./cleanup.sh
...
# Confirmación
print_warning "Esto eliminará NGINX y todas las configuraciones."
...
# Eliminar paquete NGINX
print_info "Eliminando paquete NGINX..."
...
# Eliminar configuración del lab (por si nginx no se eliminó por completo)
if [[ -f /etc/nginx/conf.d/lab-ssl.conf ]]; then
  rm -f /etc/nginx/conf.d/lab-ssl.conf
  print_success "Configuración del lab eliminada"
fi
