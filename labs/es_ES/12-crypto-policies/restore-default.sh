...
# Cambiar a DEFAULT
print_info "Cambiando a la política DEFAULT..."
if update-crypto-policies --set DEFAULT; then
  print_success "Política establecida en DEFAULT"
else
  print_error "No se pudo establecer la política DEFAULT"
  exit 1
fi
...
echo
print_success "Restaurado a la política DEFAULT"
echo
echo "La política DEFAULT proporciona:"
echo "  - TLS 1.2 y 1.3"
echo "  - Cifrados fuertes"
echo "  - Buen equilibrio entre seguridad y compatibilidad"
