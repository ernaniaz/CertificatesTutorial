#!/usr/bin/env bash
#=============================================================================
# Lab 17: Copia de seguridad de certificados
# Respaldo integral de certificados
#
# Uso: ./backup-certificates.sh
# Requisitos previos: RHEL 7, privilegios de root
#=============================================================================
...
print_header "Lab 17: Respaldo de certificados"
...
Respaldo de certificados RHEL 7
Fecha: $(date)
