...
#=============================================================================
# Lab 16: Limpieza
# Elimina certificados de emergencia
#
# Uso: ./cleanup.sh
...
print_info "Eliminando certificados de emergencia..."

# Eliminar certificados de emergencia
...
# Eliminar archivos de respaldo y reversión
...
print_success "Certificados de emergencia eliminados"
echo

# Nota sobre directorios de respaldo
if ls -d /root/cert-backup-* /root/cert-before-restore-* 2>/dev/null; then
  print_info "Directorios de respaldo encontrados:"
  ls -d /root/cert-backup-* /root/cert-before-restore-* 2>/dev/null
  echo
  echo "Estos respaldos se conservan"
  echo "Elimine manualmente si no los necesita:"
