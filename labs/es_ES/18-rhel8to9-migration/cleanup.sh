...
print_header "Lab 18: Limpieza"

print_info "Limpiando archivos de prueba..."

rm -f /tmp/migration-test-* /tmp/test.key /tmp/test.crt

print_success "Limpieza completada"
echo
echo "Archivos de respaldo conservados en:"
if ! ls -lh /root/rhel8-cert-backup-*.tar.gz 2>/dev/null; then
